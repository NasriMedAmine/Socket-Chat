...
class ResultController extends AbstractController
{
    ...
    /**
     * @Route("/{idResult}", name="app_result_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idResult}/edit", name="app_result_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{idResult}", name="app_result_delete", methods={"POST"})
     */
    public function delete(Request $request, Result $result, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$result->getIdResult(), $request->request->get('_token'))) {
